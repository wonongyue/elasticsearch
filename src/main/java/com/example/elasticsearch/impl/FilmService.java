...
import com.example.elasticsearch.dao.FilmDao;
...
public class FilmService {
    ...
    public List<FilmEntity> accurateQuery(String name) {
       QueryBuilder queryBuilder = QueryBuilders.queryStringQuery(name).field("name");
